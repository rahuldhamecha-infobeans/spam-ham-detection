...
class Transcript(db.Model):
    ...
    def __init__(self, name,transcript=None,added_by=0,overall_interviewer_transcript_report=None,overall_candidate_transcript_report=None,transcript_analysis_status='pending'):
        self.name = name
